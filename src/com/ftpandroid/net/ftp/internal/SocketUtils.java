...
public class SocketUtils {
     ...
     * Availability is tested by trying to create instances
     * 
    ...
    /**
     * Test if a socket is connected by using the isConnected method,
     * If can't check it assumes the socket is connected.
     * 
